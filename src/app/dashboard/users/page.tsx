                ...
                <Table>
                    <TableHeader>
                        <TableRow>
                            ...
                            <TableHead>{isClient ? usersDict.tableHeaderPassword : defaultGlobalDict.manageUsersPage.tableHeaderPassword}</TableHead>
                                    ...
                                    <TableCell>
                                        {canViewPassword ? (
                                            <div className="flex items-center gap-1">
                                                ...
                                                {!user.password && <span className="text-xs text-muted-foreground italic ml-1">({isClient ? usersDict.passwordNotSet : defaultGlobalDict.manageUsersPage.passwordNotSet})</span>}
                                            </div>
