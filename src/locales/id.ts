...
const id = {
  ...
  // Dashboard Layout
   dashboardLayout: {
    ...
    manageWorkflows: 'Kelola Alur Kerja', // New key
  ...
  dashboardPage: {
    ...
    status: {
      ...
      pendingarchitectfiles: 'MEP - Arsitek',
      pendingstructurefiles: 'MEP - Struktur',
  ...
  manageWorkflowsPage: {
    ...
    toast: {
      ...
      addComingSoon: 'Penambahan alur kerja baru akan tersedia di pembaruan mendatang.',
