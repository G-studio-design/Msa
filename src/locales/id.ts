...
const id = {
  ...
  projectsPage: {
    ...
    rejectButton: 'Tolak / Minta Revisi',
    ...
    workflowActions: {
      ...
      reviseAdminFiles: 'Revisi Berkas Administrasi',
      reviseArchitectFiles: 'Revisi Berkas Arsitektur',
      reviseStructureFiles: 'Revisi Berkas Struktur',
      reviseMepFiles: 'Revisi Berkas MEP',
  ...
  manageUsersPage: {
   ...
   adminActionsPage: {
       ...
       newNextActionPlaceholder: 'Jelaskan langkah selanjutnya',
  ...
  manageWorkflowsPage: {
    ...
    addDialogStepsInfo: 'Langkah-langkah alur kerja akan diatur ke struktur default. Anda dapat menyesuaikannya nanti (fitur segera hadir).',
    ...
    formPlaceholders: {
      ...
      description: 'Jelaskan tujuan atau tipe alur kerja ini',
    },
    validation: {
    ...
    toast: {
      ...
      addSuccessDesc: 'Alur kerja "{name}" telah dibuat dengan langkah default.',
  ...
  settingsPage: {
    ...
    googleCalendarConnectDesc: 'Izinkan Msarch App mengakses Google Kalender Anda untuk membuat acara sidang proyek.',
