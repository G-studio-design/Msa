...
const en = {
  ...
  projectsPage: {
    ...
    rejectButton: 'Reject / Request Revision',
  ...
  manageWorkflowsPage: {
    ...
    addDialogStepsInfo: 'Workflow steps will be set to a default structure. You can customize them later (feature coming soon).',
