...
export default function AddProjectPage() {
  ...
  // isLoadingWorkflows and fetchedWorkflows are no longer needed

  React.useEffect(() => {
    setIsClient(true);
  }, []);

  // Fetching workflows is no longer needed
  // React.useEffect(() => {
  ...
  // workflowId removed from form values
  ...
  const form = useForm<AddProjectFormValues>({
    ...
    defaultValues: {
      title: '',
      // workflowId: undefined, // No longer a form field
    },
  });
  ...
  React.useEffect(() => {
    ...
    // Setting default workflowId in form is no longer needed
  ...
  const onSubmit = async (data: AddProjectFormValues) => {
    ...
    try {
      ...
      // Error message for WORKFLOW_INVALID might still be relevant if default workflow has issues
    ...
    // isLoadingWorkflows check removed from here
                 ...
                 <Card>
                     ...
                     <CardContent>
                         <div className="space-y-4">
                             ...
                             {/* Skeleton for workflow select removed */}
            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
              ...
              <div className="space-y-2">
               ...
               <div className="flex flex-col sm:flex-row justify-end gap-2">
                  ...
                  {/* isLoadingWorkflows check removed from disabled condition */}
